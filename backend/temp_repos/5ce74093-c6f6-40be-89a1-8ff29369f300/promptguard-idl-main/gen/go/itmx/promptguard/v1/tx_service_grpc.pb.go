...
const (
	TxService_GetTxScores_FullMethodName = "/itmx.promptguard.v1.TxService/GetTxScores"
)
...
type TxServiceClient interface {
	GetTxScores(ctx context.Context, in *GetScoreRequest, opts ...grpc.CallOption) (*GetScoreResponse, error)
}
...
func (c *txServiceClient) GetTxScores(ctx context.Context, in *GetScoreRequest, opts ...grpc.CallOption) (*GetScoreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetScoreResponse)
	err := c.cc.Invoke(ctx, TxService_GetTxScores_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TxServiceServer interface {
	GetTxScores(context.Context, *GetScoreRequest) (*GetScoreResponse, error)
...
func (UnimplementedTxServiceServer) GetTxScores(context.Context, *GetScoreRequest) (*GetScoreResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTxScores not implemented")
}
...
func _TxService_GetTxScores_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetScoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TxServiceServer).GetTxScores(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TxService_GetTxScores_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TxServiceServer).GetTxScores(ctx, req.(*GetScoreRequest))
	}
...
var TxService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "itmx.promptguard.v1.TxService",
	HandlerType: (*TxServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTxScores",
			Handler:    _TxService_GetTxScores_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "itmx/promptguard/v1/tx_service.proto",
}
